  ...
  return (
    <section className="w-full flex justify-center mt-10 sm:mt-40 items-center flex-col p-4">
      ...
      <p className="max-w-2xl my-10 bg-yellow-200 p-8 rounded-xl text-lg">
        The idea here is to provide you with insights into your data similar to
        ...
        authentication flow as Strava handles the authentication, I just handle
        the keys that are returned to me from the API, these are hashed values.
        For more information on the flow you can read about it{" "}
        <a
